...
public class ViewAllPostsWindow extends JFrame {
    ...
    private JScrollPane createItemsPanel() {
        ...
        allReports = lostItemDAO.getAllItems();
    ...
    private void displayReports(ArrayList<ReportCard> reports) {
    ...
    private void filterItems(
        ...
        ArrayList<ReportCard> filteredReports = new ArrayList<>();
        ...
        for (ReportCard report : allReports) {
            ...
            } else if (selectedFilter.equalsIgnoreCase("Lost")
            ...
            } else if (selectedFilter.equalsIgnoreCase("Found")
                    && report.getItemType() != null
                    && report.getItemType()
                            .equalsIgnoreCase("Found")) {
                filteredReports.add(report);

            } else if (selectedFilter.equalsIgnoreCase("Claimed")
                    && report.getStatus() != null
                    && report.getStatus()
                            .equalsIgnoreCase("Claimed")) {
    ...
    private void addItemCard(String itemName,
            String dateLost,
            String location,
            String status) {
        ...
        } else if (status.equalsIgnoreCase("Approved") || status.equalsIgnoreCase("Found")) {
        ...
        btnDelete.setFont( Fonts.Bold.deriveFont(13f));

        btnView.setBackground( Colors.DARK_BLUE_TEXT_COLOR);

        btnDelete.setBackground(Colors.DARK_BLUE_TEXT_COLOR);
